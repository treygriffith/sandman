var fork = require('child_process').fork
  ...
  , interfacePath = require.resolve('./client');
...
Sandman.prototype.start = function () {
  ...
  this.interface.send({ filename: this.filename, root: this.root, arguments: this.arguments });
};
...
Sandman.prototype._onMessage = function (msg) {
