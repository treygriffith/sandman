...
exports.require = function (filename, module, isEntrypoint) {
  ...
  // create a safe parent for the next require, but don't give access to the entrypoint's `require`
  if(isEntrypoint) {
    safeParent.id = module.id;
    safeparent.loaded = module.loaded;
    safeParent.parent = {};
    safeParent.children = module.children;
    safeParent.exports = module.exports;
    safeParent.require = this.require(module.id, module.parent);
  } else {
    safeParent = module;
  }
